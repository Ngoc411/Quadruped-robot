...
for i in range(len(X)):
    ...
    straForeAlphaTIM.append(alphaTIM)
    straForeBetaTIM.append(betaTIM)
# print(alphaMainArr)
# print()
# print(alphaBaseArr)
# print()
...
# print()
# print(betaBottomArr)
print(f"int straForeAlphaTIM[] = {straForeAlphaTIM};")
print()
print(f"int straForeBetaTIM[] = {straForeBetaTIM};")

# Kiểm tra tính liên tục
alpha_continuity = check_continuity(straForeAlphaTIM)
beta_continuity = check_continuity(straForeBetaTIM)
