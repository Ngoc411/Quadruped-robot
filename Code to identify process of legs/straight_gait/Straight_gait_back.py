...
for i in range(len(X)):
    ...
    straBackAlphaTIM.append(alphaTIM)
    straBackBetaTIM.append(betaTIM)
# print(alphaMainArr)
# print()
# print(alphaBaseArr)
# print()
...
# print()
# print(betaBottomArr)
print(f"int straBackAlphaTIM[] = {straBackAlphaTIM};")
print()
print(f"int straBackBetaTIM[] = {straBackBetaTIM};")

# Kiểm tra tính liên tục
alpha_continuity = check_continuity(straBackAlphaTIM)
beta_continuity = check_continuity(straBackBetaTIM)
