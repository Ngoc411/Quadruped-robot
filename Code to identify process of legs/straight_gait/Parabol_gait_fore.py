...
for i in range(len(X)):
    ...
    palForeAlphaGaitTIM.append(alphaTIM)
    palForeBetaGaitTIM.append(betaTIM)
...
print()
# print(betaBottomArr)
print(f"int palForeAlphaTIM[] = {palForeAlphaGaitTIM};")
print()
print(f"int palForeBetaTIM[] = {palForeBetaGaitTIM};")

# Kiểm tra tính liên tục    
alpha_continuity = check_continuity(palForeAlphaGaitTIM)
beta_continuity = check_continuity(palForeBetaGaitTIM)
