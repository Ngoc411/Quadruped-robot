...
for i in range(len(X)):
    ...
    straAlphaGaitTIM.append(alphaTIM)
    straBetaGaitTIM.append(betaTIM)
...
print(f"int straAlphaGaitTIM[] = {straAlphaGaitTIM};")
print()
print(f"int straBetaGaitTIM[] = {straBetaGaitTIM};")

# Kiểm tra tính liên tục
alpha_continuity = check_continuity(straAlphaGaitTIM)
beta_continuity = check_continuity(straBetaGaitTIM)
