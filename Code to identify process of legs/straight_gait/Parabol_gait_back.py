...
for i in range(len(X)):
    ...
    palBackAlphaTIM.append(alphaTIM)
    palBackBetaTIM.append(betaTIM)
...
# print()
# print(betaBottomArr)
print(f"int palBackAlphaTIM[] = {palBackAlphaTIM};")
print()
print(f"int palBackBetaTIM[] = {palBackBetaTIM};")
print()

# Kiểm tra tính liên tục
alpha_continuity = check_continuity(palBackAlphaTIM)
beta_continuity = check_continuity(palBackBetaTIM)
